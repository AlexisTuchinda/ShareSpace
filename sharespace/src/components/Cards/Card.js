...
class Card extends React.Component {
    constructor (props){
        ...
        this.state = {
            ...
            voting: null,
            commenting: null //find way to sustain values of comments + votes for each card w/o reseting to null
        };
    }
    ...
    checkAuthentication(){ 
        if (this.state.isAuthenticated){
            this.setState({voting: <Vote/>, commenting:<CommentBox username = {this.state.username}/>})
        }else{
